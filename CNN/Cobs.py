...
class CardDetector:
    def __init__(self, model_path, folder_path, width=640, height=480):
        ...
        self.display_image = cv2.imread('C:/Users/62811/PCV/Big Project/game/Background.png')
    ...
    def show_card_images(self, deck, position):
        ...
        for card_value in deck:
            card_image = cv2.imread(f"C:/Users/62811/PCV/Big Project/game/assetCards/{card_value}.png")  
...
#run game
model_path = 'C:/Users/62811/PCV/Big Project/CNN/DatasetH5PY/ALLINONE.h5'
folder_path = r"C:/Users/62811/PCV/Big Project/CNN/Dataset/Training/Images"
